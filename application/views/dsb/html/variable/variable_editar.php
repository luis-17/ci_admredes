				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?=base_url()?>index.php/variables_plan">Coberturas</a></li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="<?=base_url()?>index.php/variable_guardar">
									<input type="hidden" id="idvariable" name="idvariable" value="<?=$idvariable?>" />

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nombre Variable: </label>

										<div class="col-sm-9">
											<input type="text" id="nombre" name="nombre" value="<?=$nombre_variable?>" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="descripcion" name="descripcion" placeholder="Digitar una descripción" cols="50" rows="3" value="<?=$descripcion?>"></textarea>
										</div>
									</div>
