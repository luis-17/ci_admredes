							...
							<div class="col-xs-9">
								...
								<form class="form-horizontal" name="form1" id="form1" role="form" method="post">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">¿Desea eliminar la serie <?=$serie?>?</label>
									</div>								
		...
		<script>
   			$(document).ready(function() {
   				...
   				$("#form1").submit(function(e) {
    				e.preventDefault();
		            $.ajax({
		                url: "<?= BASE_URL()?>index.php/Series_cnt/delete_serie",
		                type: 'POST',
		                dataType: 'json',
		                data: $("#form1").serialize(),
		                complete:function(){
		                    alert('Se eliminó la serie.');
