					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="formSave" name="formSave" role="form" method="post">

									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Código CIE: </label>

										<div class="col-sm-9">
											<input type="text" id="codigo_cie" name="codigo_cie" class="col-xs-10 col-sm-8" value=""><label style="color: #FF0101;">&nbsp;*</label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="descripcion_cie" name="descripcion_cie" class="col-xs-10 col-sm-8" value=""><label style="color: #FF0101;">&nbsp;*</label>
										</div>
									</div>
		...
		<script>
			$(document).ready(function() {
   				$("#formSave").submit(function(e) {
    				e.preventDefault();
		            $.ajax({
		                url: "<?= BASE_URL()?>index.php/Diagnosticos_cnt/save_datos",
		                type: 'POST',
		                dataType: 'json',
		                data: $("#formSave").serialize(),
		                complete:function(){
		                    alert('Se creó el diagnóstico correctamente');
							window.location.href = ("<?= BASE_URL()?>index.php/diagnosticos_add");
		                },
