					...
					<div class="page-content">	
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div align="center">
									<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="aseg" id="aseg" role="form" method="post" action="<?=base_url()?>index.php/save_servicio"  enctype="multipart/form-data">					
									
									<input type="hidden" id="id_servicio" name="id_servicio" value="<?=$id_servicio;?>" />									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Descripción: </label>

										<div class="col-sm-4">
											<input  class="form-control input-mask-date" type="text" id="descripcion" name="descripcion" value="<?=$descripcion?>"  required>
										</div>
									</div>
									<?php if($id_servicio<>0){ ?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"></label>

										<div style="text-align: left;" class="col-sm-4">
											<img style="height: 60px; width: 60px;" src="https://www.red-salud.com/rsadmin/iconos/servicios/<?=$id_servicio?>.png">
										</div>
									</div>
									<?php } ?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Ícono: </label>

										<div style="text-align: left;" class="col-sm-4">
											<input type="file" id="mi_archivo" name="mi_archivo" class="" value="" accept="application/png">
										</div>
									</div>									
									<div align="center" style="text-align: center;" class="clearfix form-actions">
										<div style="text-align: center;" class="col-md-offset-3 col-md-7">
