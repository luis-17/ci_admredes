	...
	<body style="">	
			...
			<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-9">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="<?=base_url()?>index.php/reg_cc">
									<input type="hidden" name="idplan" value="<?=$idplan?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Centro de Costo (CC): </label>
										<div class="col-sm-9">
											<input min="1" type="number" id="numero" name="numero" required="true" value="<?=$centro_costo?>">
										</div>
									</div>								
