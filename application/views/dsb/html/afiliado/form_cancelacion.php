			...
			<!-- /section:basics/content.breadcrumbs -->
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
							<form class="form-horizontal" name="can" id="can" role="form" method="post" action="<?=base_url()?>/index.php/email">
								<div class="form-group">
									...
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Motivo de Cancelación: </label>

									<div class="col-sm-4">
										<textarea name="can_motivo" id="can_motivo" cols="95" rows="5" maxlength="800"></textarea>
									</div>
								</div>
