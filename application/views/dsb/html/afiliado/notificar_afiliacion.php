			...
			<!-- /section:basics/content.breadcrumbs -->
				<div class="page-content">
					<div class="page-header">
						<h1>
							DATOS DE CONCACTO DEL CONTRATANTE						
						</h1>
					</div>
					<div class="row">
						<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
							<form class="form-horizontal" name="aseg" id="aseg" role="form" method="post" action="<?=base_url();?>index.php/notificar_afiliacion">
								<input type="hidden" name="cert_id" id="cert_id" value="<?=$cert_id;?>">
								<input type="hidden" name="cont_id" id="cont_id" value="<?=$cont_id;?>">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> DNI: </label>
									<div class="col-sm-9">
										<input class="form-control" type="text" name="" id="" value="<?=$dni?>" disabled> 
									</div>
								</div>		
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombres y Apellidos: </label>
									<div class="col-sm-9">
										<input class="form-control" type="text" name="" id="" value="<?=$contratante?>" disabled> 
									</div>
								</div>									
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Correo electrónico: </label>
									<div class="col-sm-9">
										<input class="form-control" type="text" name="cont_email" id="cont_email" value="<?=$cont_email?>"> 
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input class="form-control" type="text" name="cont_telf" id="cont_telf" value="<?=$cont_telf?>"> 
									</div>
								</div>										
								<div class="">
...
<![endif]-->
		...
		<script type="text/javascript">
			function guardar() {
				alert("Se registró la incidencia con éxito");
