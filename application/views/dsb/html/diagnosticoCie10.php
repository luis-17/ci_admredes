...
<html lang="en">
	<head>
		...
		<!-- inicio links paginacion -->
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>
		 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
		 <!-- fin links paginacion -->
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Diagnóstico CIE10</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<body>
									 <div class="tabbable">
									  <h3 align="center">Data Diagnostico</h3>
		...
		<!-- inicio scripts paginacion -->
		<script>
			$(document).ready(function(){

			 function load_diagnostico_data(page)
			 {
			  $.ajax({
			   url:"<?php echo base_url(); ?>diagnosticoCie10_cnt/pagination/"+page,
			   method:"GET",
			   dataType:"json",
			 ...
			 load_diagnostico_data(1);

			 $(document).on("click", ".pagination li a", function(event){
			  event.preventDefault();
			  var page = $(this).data("ci-pagination-page");
			  load_diagnostico_data(page);
			 });
