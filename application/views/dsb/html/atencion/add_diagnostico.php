...
<script type="text/javascript">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">        
		<form id="form2" name="form2" role="form" action="<?=base_url()?>index.php/guardaDiagP" method="post">	
			<div class="form-group col-md-6">
				<h4 style="color:#033766;">Diagnóstico Principal</h4>
					<div id="messageAtention">
						<h5>Ingrese las primeras letras de su diagnóstico y ubique el código CIE en la lista desplegable. A continuación genere el tratamiento para dicho diagnóstico. Si desea ingresar un medicamento no cubierto, ingreselos en el área "Tratamiento No Cubierto".  </h5>
					</div>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function($) {
			...
			$.ajax({				                	
				...
				url: '<?=base_url()?>public/jqueryTratamiento/search.php', 
				type: 'GET',
