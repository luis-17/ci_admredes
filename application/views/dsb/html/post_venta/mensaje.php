							...
							<div class="col-xs-12">
								...
								<div class="widget-main">
									...
									<?php 
												echo '<div class="alert alert-info">
															Gracias Sr (a) <b>'.$nombre.'</b> por su tiempo, sus respuestas nos ayudarán a brindarle un mejor servicio…Que tenga <b>'.$turno.'</b>.
													</div>';
									?>									
								...
								<div class="">
									<div class="col-md-offset-3 col-md-9" style="text-align: right;">
										<?php if($tipo_mensaje==1){ ?>
										<button class="btn btn-info" onclick="guardar()" >
											<i class="ace-icon fa fa-check bigger-110"></i>
												Cerrar
										</button>
										<?php }else{ ?>
										<a href="https://www.red-salud.com" class="btn btn-info">Cerrar</a>
										<?php } ?>
									</div>
								</div>							
							</div><!-- /.col -->
