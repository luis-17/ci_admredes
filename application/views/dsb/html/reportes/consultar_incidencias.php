									...
									<div class="tab-content no-border padding-24">
										...
										<div id="faq-tab-3" class="tab-pane fade">
											...
											<div class="col-xs-12">
												...
												<!-- end table -->
												<table align="center" id="example3" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																<th>Fecha Reg.</th>
														...
														<tbody>
															<?php foreach ($detalle_incidencias as $di) {
																if($di->tiempo<60){
																	$tiempo = $di->tiempo.' minutos(s)';
																}elseif($di->tiempo<1440){
																	$tiempo = round($di->tiempo/60,0);
																	$tiempo = $tiempo.' hora(s)';

																}else{
																	$tiempo = round($di->tiempo/1440);
																	$tiempo = $tiempo.' día(s)';
																}
															?>
															<tr>
																<td><?=$di->fech_reg?></td>	
																<td><?=$di->registra?></td>														
																<td><?=$di->nombre_comercial_cli?></td>
																<td><?=$di->nombre_plan?></td>
																<td><?=$di->aseg_numDoc?></td>
																<td><?=$di->asegurado?></td>
																<td><?=$di->tipoincidencia?></td>
																<td><?=$di->asignado?></td>
																<td><?=$di->fecha_solucion?></td>
																<td><?=$tiempo?></td>
															</tr>
															<?php } ?>
														</tbody>
