	...
	<body style="">	
			...
			<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="<?=base_url()?>index.php/reg_evento">
									<input type="hidden" name="id" id="id" value="<?=$idusuario_asignado?>">
									<input type="hidden" name="idincidente" id="idincidente" value="<?=$idincidente?>">

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Notificar a: </label>
										<div class="col-sm-7">
											<input type="hidden" name="idusuario_asignado" id="idusuario_asignado" value="<?=$idusuario_asignado?>">
											<input type="text" class="form-control" name="" value="<?=$colaborador?>" disabled>
										</div>
									</div>
