													...
													<table style="font-size: 12px;" id="example" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																...
																<td><?=$h->registra?></td>
																<td><?=$h->descripcion?></td>
																<td><span class="<?=$h->class?>"><?=$h->estado?></span></td>
																<td><?=$h->recepciona?></td>
																<td>
																	<div title="Ver Historial" style="float:left;cursor:pointer;" class="ui-pg-div ui-inline-edit" id="jEditButton_12" onclick="" data-original-title="Edit selected row">
																		&nbsp;<a class="boton fancybox" href="<?=base_url()?>index.php/historial/<?=$h->idincidencia?>" data-fancybox-width="950" data-fancybox-height="690">
