	...
	<head>
	    ...
	    $(document).ready(function() {  
		 	$("#item").change(function(){  
			   var url = '<?php echo base_url()?>index.php/detalle_producto2'; 
			   var id = $('#item').val();
		  	 	$.ajax({  
			    url: url,  
			    data: { id : id },  
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="form" name="form" role="form" method="post" action="<?=base_url()?>index.php/guardar_cotcobertura">
									<input type="hidden" id="nom" name="nom" value="<?=$nom;?>">
									<input type="hidden" name="idcotizaciondetalle" id="idcotizaciondetalle" value="<?=$id?>">
									<input type="hidden" id="idcotizacioncobertura" name="idcotizacioncobertura" value="<?=$iddet?>" />
										...
										<br>
											<table id="example" class="table table-bordered table-hover"  style="font-size: 12px;">
												...
												<tbody style="font-size: 12px;">
													...
													foreach($cobertura as $c):
														...
														switch ($c->tiempo) {
															case '1 month':
																$tiempo= '<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Editar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'">'.$num." Menual(es) </a>";
															break;															
															case '2 month':
																$tiempo= '<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Editar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'">'.$num." Bimestral(es)</a>";
															break;
															case '3 month':
																$tiempo= '<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Editar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'">'.$num." Trimestral(es)</a>";
															break;
															case '6 month':
																$tiempo= '<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Editar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'">'.$num." Semestral(es)</a>";
															break;
															case '1 year':
																$tiempo= '<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Editar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'">'.$num." Anual(es)</a>";
															break;
															case 'ilimitados':
																$tiempo= "Ilimitados";
															break;
															default:
																$num="";
																$tiempo='<a class="boton fancybox"  data-fancybox-width="600" data-fancybox-height="400" title="Agregar Evento" href="'.base_url().'index.php/eventos_cotizacion/'.$c->idcotizacioncobertura.'"><i class="ace-icon glyphicon glyphicon-plus red"></i></a>';
															break;
														}
													...
													<tr>
														...
														<td><a class="boton fancybox"  data-fancybox-width="800" data-fancybox-height="700" href="<?=base_url()?>index.php/coaseguro_cotizacion/<?=$c->idcotizacioncobertura;?>/<?=$nom?>" title="Agregar Coaseguro" href=""><i class="ace-icon glyphicon glyphicon-plus red"></i></a> <?=$c->cobertura?></td>
														<td><?=$tiempo?></td>
														<td>
															<div class="hidden-sm hidden-xs btn-group">
																...
																<div title="<?=$titulo?>" style="float:left;cursor:pointer;" class="ui-pg-div ui-inline-edit" id="jEditButton_12" onclick="" data-original-title="Edit selected row">
																	&nbsp;<a href="<?=base_url()?>index.php/<?=$funcion?>/<?=$id?>/<?=$nom?>/<?=$c->idcotizacioncobertura;?>">
											...
											<div class="clearfix form-actions">
												<div class="col-md-offset-3 col-md-9">
													<a href="<?=base_url()?>index.php/cotizacion_variables/<?=$id?>/<?=$nom?>" class="btn btn-info">
