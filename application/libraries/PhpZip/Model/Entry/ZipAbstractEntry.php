...
include ('./application/libraries/PhpZip/Extra/ExtraFieldsCollection.php');
include ('./application/libraries/PhpZip/Util/DateTimeConverter.php');
include ('./application/libraries/PhpZip/Extra/ExtraFieldsFactory.php');
/**
 * Abstract ZIP entry.
 *
