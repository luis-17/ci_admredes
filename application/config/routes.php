...
$route['seleccionar_proveedor/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'Certificadodetalle_cnt/seleccionar_proveedor/$1/$2/$3/$4/$5/$6';
$route['validar_evento/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'Certificadodetalle_cnt/validar_evento/$1/$2/$3/$4/$5';
$route['reservar_cita/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'Certificadodetalle_cnt/reservar_cita/$1/$2/$3/$4/$5/$6/$7';
